...
# Define default values for temperature and repetition penalty
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to LLaMA model file (default: auto-download LLaMA model)",
    )
    parser.add_argument(
        "--output",
        type=str,
    ...
    parser.add_argument(
        ...
        help="Temperature for text generation (0.0-1.0, lower is more deterministic, default: 0.7)",
    )
    parser.add_argument(
        "--repeat-penalty",
        dest="repeat_penalty",
        ...
        help="Repetition penalty (1.0+ higher values penalize repetition more, default: 1.2)",
    )
...
def summarize_text(model: Llama, text: str, temperature: float = 0.7, repetition_penalty: float = 1.2) -> str:
    print("Generating summary...")
    print(f"Using temperature: {temperature}, repetition penalty: {repetition_penalty}")
    start_time = time.time()
